...
<meta property="og:locale" content="en_GB" />
      <!--pre connecting/fetching external links -->
                ...
                <link rel="preload" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
          <link rel="preload" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
...
<!--Bootstrap css cdn-->
      ...
      <header>
         ...
         <div id="home">
            <div class="text-center">
             ...
             <p>This website uses cookies which are <strong>essentail</strong> for this website to function. I don't use any tracking, analytical or marketing cookies because I believe privacy online is a fundamental right. <button type="button" class="btn btn-light" id="cookie-dismiss">Dismiss</button></p>
            ...
            <div class="container">
               <div class="desktop">
                     ...
                     <div class="col-sm-6 text-center">
                        <div class="card yellow-shadow">
                           <div class="card-body rounded">
                              <img class="lazy" data-src="https://shanelucy.me/images/creativity.png" src="placeholder" alt="A lightbulb, cloud and pen merging inside a box surrounded by stars" data-toggle="tooltip" title="Icons made by https://www.freepik.com/" />
                           </div>
                        </div>
                     </div>
                     <div class="col-sm-6">
                  ...
                  <div class="row pad-5">
                     ...
                     <div class="col-sm-6 text-center">
                        <div class="card blue-shadow">
                           <div class="card-body rounded">
                              <img class="lazy" data-src="https://shanelucy.me/images/thinking.png" src="placeholder" alt="A lightbulb inside a head" data-toggle="tooltip" title="Icon made by https://www.flaticon.com/authors/eucalyp" />
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row pad-5">
                     <div class="col-sm-6 text-center">
                        <div class="card yellow-shadow">
                           <div class="card-body rounded">
                              <img class="lazy" data-src="https://shanelucy.me/images/launch.png" src="placeholder" alt="A rocket flying upwards" data-toggle="tooltip" title="Icons made by https://www.freepik.com/ from https://www.flaticon.com/" />
                           </div>
                        </div>
                     </div>
                     <div class="col-sm-6">
                  ...
                  <div class="row pad-5">
                     ...
                     <div class="col-sm-6 text-center">
                        <div class="card blue-shadow">
                           <div class="card-body rounded">
                              <img class="lazy" data-src="https://shanelucy.me/images/lock.png" src="placeholder" alt="A lock" data-toggle="tooltip" title="Icon made by https://www.flaticon.com/authors/pixel-perfect" />
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="mobile text-center">
                  ...
                  <div class="row pad-top">
                     <div class="card yellow-shadow">
                        <div class="card-body rounded">
                           <img class="lazy" data-src="https://shanelucy.me/images/launch.png" src="placeholder" alt="A rocket flying upwards" data-toggle="tooltip" title="Icon made by https://www.flaticon.com/authors/pixel-perfect" />
                  ...
                  <div class="col-sm-6">
                     <div class="card yellow-shadow">
                        <div class="card-body rounded">
                           ...
                           <img class="card-img-top lazy" data-src="https://shanelucy.me/images/sundayRoastsDesktop.png" src="placeholder" alt="A website I developed for a clan in the game Clash Royale" data-toggle="tooltip" title="Click to visit me!" />
                           </a>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                     <div class="card blue-shadow">
                        <div class="card-body rounded">
                           ...
                           <img class="card-img-top lazy" data-src="https://shanelucy.me/images/huntingLodgeDesktop.png" src="placeholder" alt="The Woodhill Hunting Lodge" data-toggle="tooltip" title="Click to visit me!" /></a>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-6">
            ...
            <div class="container mobile">
               ...
               <div class="row pad-top">
                  <div class="col-sm-12 card yellow-shadow">
                     <div class="card-body rounded">
                        <a href="https://sundayroasts.xyz/" target="_blank" rel="noopener">
                       <img class="card-img-top lazy" data-src="https://shanelucy.me/images/sundayRoastsMobile.png" src="placeholder" alt="A website I developed for a clan in the game Clash Royale" data-toggle="tooltip" title="Click to visit me!" />
                        </a>
                        <h3 class="card-title">Sunday Roasts</h3>
                        <p class="card-text">
                           This website was developed to automate the process of tracking member participation within the clan. I used PHP and bootstrap to develop this website.
               ...
               <div class="row pad-top">
                  <div class="col-sm-12 card blue-shadow">
                     <div class="card-body rounded ">
                        <a href="http://www.thewoodhill.uk" target="_blank" rel="noopener">
                        <img class="card-img-top lazy"  data-src="https://shanelucy.me/images/huntingLodgeMobile.png" src="placeholder" alt="The Woodhill Hunting Lodge" data-toggle="tooltip" title="Click to visit me!" />
                        </a>
                        <h3 class="card-title">The Woodhill Huntinglodge</h3>
   ...
   <label for="enquiry">Enquiry: *</label>
    ...
    <span id="enquiry-error"  aria-live="polite"></span>
      ...
      <script nonce="<?php echo $nonce;?>" src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
   ...
   <script nonce="<?php echo $nonce;?>" src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
